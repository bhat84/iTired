 ...
 * @throws FileNotFoundException 
    ...
    *********************************************************************/
    ...
    //---------------------------------------------
        ...
        File file = new File("C:\\Praveen\\Master Program\\Spring 2015\\Coding\\CodingPractice\\src\\5-31-3_output.txt");
		Scanner sc = new Scanner(file);
		int k= 0;
		int count = 0;
	double median_freq[]  = new double[50];
	while(sc.hasNextLine()) 
	{
        ...
        double nextData;
        for ( int j = 0 ; j < N; j++) {	
			nextData = sc.nextDouble();
			
			 x[j] = new Complex(nextData, 0);
  ...
  //Compute area of spectrum
   ...
   System.out.println(area);
    ...
    median_freq[k] = m*df;
    count=0;
    System.out.println(median_freq[k]);  
    k++;
