 ...
 * @author Praveen Bhat
 * This class will provide list of patients and allows to pull that information.
 * But the class is not enabled in this project and kept as it is to maintain the integrity of the program.  
 */
